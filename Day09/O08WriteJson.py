...
print("-" * 40)
empdata = {'name': "Keneth", "age": 32, "city": "Johanesburg"}
print(empdata)
print(type(empdata))
...
# dump = used to write python serialized object as json formatted data
# dumps = used to encode any python object into json formatted string
